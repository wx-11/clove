...
export function AccountModal({ account, onClose }: AccountModalProps) {
    const [formData, setFormData] = useState({
        ...
        prefer_mode: null as 'oauth' | 'web' | null,
    })
    ...
    useEffect(() => {
        if (account) {
            setFormData({
                ...
                prefer_mode: account.prefer_mode || null,
            })
    ...
    const handleSubmitAccount = async () => {
        ...
        try {
            if (account) {
                ...
                if (formData.prefer_mode !== account.prefer_mode) {
                    updateData.prefer_mode = formData.prefer_mode
                }
                ...
                if (formData.prefer_mode) {
                    createData.prefer_mode = formData.prefer_mode
                }
                    ...
                    <CollapsibleContent className='space-y-4 mt-4'>
                        ...
                        <div className='space-y-2'>
                            ...
                            <Select
                                ...
                                onValueChange={value =>
                                    setFormData({ ...formData, prefer_mode: value === 'auto' ? null : (value as 'oauth' | 'web') })
                                }
                            >
